...
class BulkUnregistrationImpl {
    constructor(_connection, _console, unregistrations) {
    ...
    dispose() {
        ...
        this._connection.sendRequest(protocol_1.UnregistrationRequest.type, params).then(undefined, (_error) => {
    ...
    disposeSingle(arg) {
        ...
        this._connection.sendRequest(protocol_1.UnregistrationRequest.type, params).then(() => {
...
class ConnectionLogger {
    ...
    send(type, message) {
        if (this._connection) {
            this._connection.sendNotification(protocol_1.LogMessageNotification.type, { type, message });
        }
    }
}
class RemoteWindowImpl {
    ...
    showErrorMessage(message, ...actions) {
        let params = { type: protocol_1.MessageType.Error, message, actions };
        return this._connection.sendRequest(protocol_1.ShowMessageRequest.type, params);
    }
    showWarningMessage(message, ...actions) {
        let params = { type: protocol_1.MessageType.Warning, message, actions };
        return this._connection.sendRequest(protocol_1.ShowMessageRequest.type, params);
    }
    showInformationMessage(message, ...actions) {
        let params = { type: protocol_1.MessageType.Info, message, actions };
        return this._connection.sendRequest(protocol_1.ShowMessageRequest.type, params);
    }
}
class RemoteClientImpl {
    ...
    registerSingle1(unregistration, type, registerOptions) {
        ...
        return this._connection.sendRequest(protocol_1.RegistrationRequest.type, params).then((_result) => {
    ...
    unregisterSingle(id, method) {
        ...
        return this._connection.sendRequest(protocol_1.UnregistrationRequest.type, params).then(undefined, (_error) => {
            this._console.info(`Unregistering request handler for ${id} failed.`);
        });
    }
    registerMany(registrations) {
        let params = registrations.asRegistrationParams();
        return this._connection.sendRequest(protocol_1.RegistrationRequest.type, params).then(() => {
...
class RemoteWorkspaceImpl {
    ...
    applyEdit(edit) {
        ...
        return this._connection.sendRequest(protocol_1.ApplyWorkspaceEditRequest.type, params);
    }
}
class TracerImpl {
    constructor(_connection) {
    ...
    log(message, verbose) {
        ...
        this._connection.sendNotification(vscode_jsonrpc_1.LogTraceNotification.type, {
            message: message,
            verbose: this._trace === vscode_jsonrpc_1.Trace.Verbose ? verbose : undefined
        });
    }
}
class TelemetryImpl {
    ...
    logEvent(data) {
        this._connection.sendNotification(protocol_1.TelemetryEventNotification.type, data);
    }
}
function createConnection(input, output) {
    ...
    let protocolConnection = {
        ...
        onExecuteCommand: (handler) => connection.onRequest(protocol_1.ExecuteCommandRequest.type, handler),
