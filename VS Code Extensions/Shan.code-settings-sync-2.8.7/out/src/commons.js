    ...
    StartMigrationProcess() {
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (firstTime) {
                ...
                vscode.window.showInformationMessage("Sync : Updated to v" + environmentPath_1.Environment.getVersion(), "Release Notes", "Write Review", "Support This Project").then(function (val) {
