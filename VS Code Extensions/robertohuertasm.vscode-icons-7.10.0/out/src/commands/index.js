...
const initVSIconsConfig = vscode_extensions_1.getConfig().vsicons;
let doReload;
let customMsgShown;
let cb;
let argms;
...
function didChangeConfigurationListener() {
    if (doReload) {
        ...
        init_1.manageApplyCustomizations(initVSIconsConfig, vscode_extensions_1.getConfig().vsicons, applyCustomizationCommand, [{ title: i18nManager.getMessage(models.LangResourceKeys.dontShowThis) }]);
    }
}
