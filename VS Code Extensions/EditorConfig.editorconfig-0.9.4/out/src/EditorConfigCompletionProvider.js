...
class EditorConfigCompletionProvider {
    constructor() {
        this.properties = [
            ...
            new Property('end_of_line', [
                'lf',
                'cr',
                'crlf',
                'unset'
            ], 'Set to lf, cr, or crlf to control how line breaks are represented.'),
            new Property('indent_style', [
                'tab',
                'space',
                'unset'
            ], 'Set to tab or space to use hard tabs or soft tabs respectively.'),
            new Property('indent_size', [
                '1',
                '2',
                '3',
                '4',
            ...
            new Property('insert_final_newline', [
                'true',
                'false',
                'unset'
            ], [
            ...
            new Property('trim_trailing_whitespace', [
                'true',
                'false',
                'unset'
            ], [
